...
Collected informations are used to create custom openfluid project, configure **model.fluidx** and **monitoring.fluidx**, then execute the OpenFLUID modeling software.
